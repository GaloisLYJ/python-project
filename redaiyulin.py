...
d7 = uiautomator2.connect_usb('127.0.0.1:62030')
d8 = uiautomator2.connect_usb('127.0.0.1:62031')

# 当前时间
now_time = time.localtime()
# 目标时间(电脑时间比北京时间快了5/6秒) 电脑休眠模拟器时间不会走 所以要提前设置
target_time = time.strptime("2019-09-10 12:00:12", "%Y-%m-%d %H:%M:%S")
...
count = 1;
while count < 3:
 d.xpath('//*[@text="抢购"]').click()
 d2.xpath('//*[@text="抢购"]').click()
 d3.xpath('//*[@text="抢购"]').click()
 d4.xpath('//*[@text="抢购"]').click()
 d5.xpath('//*[@text="抢购"]').click()
 d6.xpath('//*[@text="抢购"]').click()
 d7.xpath('//*[@text="抢购"]').click()
 d8.xpath('//*[@text="抢购"]').click()
 count = count + 1
print("finish click")
